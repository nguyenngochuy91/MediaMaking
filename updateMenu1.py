...
## button executions
    ...
    def ok(self):
        ...
        if checkedNodes:
            message = "You have chose the following media(s):\n {}. \nPlease press Ok to proceed, or Cancel to update more media".format(", ".join([item[0] for item in checkedNodes]))
        else:
            message = "You have not chosen anything, pressing Ok to go back to Main Menu, Cancel to update more media"
